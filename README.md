...
This repository implements a system where the same large language models (LLMs) are used for both generating responses and evaluating (judging) those responses. The framework leverages the Livebench dataset across multiple task categories to assess model performance.
...
#### Livebench:
- **Instruction Following** - 200 prompts (scoring - some DONE, preference - DONE, **TODO: ANALYSIS**)
- **Language** - 140 prompts (scoring - DONE, preference - DONE, **TODO: ANALYSIS**)
- **Coding** - 128 prompts (scoring - DONE, preference - DONE, **TODO: ANALYSIS**)
- **Math** - 368 prompts (generated response - DONE, scoring - TODO, preference - DONE, **TODO: ANALYSIS**)
- **Reasoning** - 149 prompts (scoring - DONE, preference - DONE, **TODO: ANALYSIS**) [Prompt 51 is skipped]
- **Data Analysis** - 150 prompts (scoring - DONE, preference - DONE, **TODO: ANALYSIS**)
...
> **Configuration Note:**  
> Set the `"llms"` parameter in the `config.json` file to specify the models you wish to use for generating responses for each dataset and task category.
